...
ICudaEngine* createEngine(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt) {
    ...
    std::map<std::string, Weights> weightMap = loadWeights("./tensorrtx/arcface/arcface-r50.wts");
    Weights emptywts{DataType::kFLOAT, nullptr, 0};
...
//             return -1;
    ...
    float * encode(unsigned char* img_data) {
        // prepare input data ---------------------------
...
//         IExecutionContext* context = static_cast<IExecutionContext*>(ptr);
        ...
        //    data[i] = 1.0;
        cv::Mat img(cv::Size(112, 112), CV_8UC3, img_data);
...
extern "C" float* encoder_encode(void *ptr, unsigned char* img_data) {
    Encoder * e = static_cast<Encoder *>(ptr);
    float * res = e->encode(img_data);
    return res;
